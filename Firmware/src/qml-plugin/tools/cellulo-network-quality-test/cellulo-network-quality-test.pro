...
linux:!android {
    ...
    TARGET = cellulo-network-quality-test
...
macx:!android {
    ...
    ICON = assets/cellulo-network-quality-test.icns
...
winrt {
    ...
    target.path = "C:/Program Files (x86)/Cellulo Network Quality Test/"
    INSTALLS += target

    WINRT_MANIFEST.publisher = "EPFL CHILI"
    WINRT_MANIFEST.name = "Cellulo Network Quality Test"
    WINRT_MANIFEST.description = "Checks connection quality to multiple robots over a cellulorobothubd or a cellulorobotpoold."
